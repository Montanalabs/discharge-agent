...
- `discharge-agent_safe.wave` — the correct design.
- `discharge-agent_unsafe.wave` — the tempting-but-wrong version (the negative example a model must learn to reject).
